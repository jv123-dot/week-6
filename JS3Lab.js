 ...
 * ↓ YOUR CODE HERE ↓ */
const myTodoList = []
let todoItems = myTodoList.push("Feed the pets", "Go grocery shopping", "Make food");
console.log(myTodoList);
let deleter = myTodoList.splice(2);
console.log(myTodoList);
const yourTodoList = ["Eat food", "Do dishes"];
...
} console.log(whichArrayIsLonger)
